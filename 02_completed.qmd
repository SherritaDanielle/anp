...
# Completed Answers for Chapter 2

## Prelab Activity 2.1 — Microscope parts
...
| Microscope Part | Correct Letter | Definition |
|---|:---:|---|
| Condenser | j | Set of lenses that collect and focus light onto the specimen. |
| Revolving Turret | g | Also known as the nosepiece; holds the objective lenses. |
| Mechanical stage | q | Section where the specimen is placed for viewing. |
| Ocular lens | e | Lens closest to the eye. |
| Power switch | p | Switch used to turn the microscope on and off. |
| Iris diaphragm | k | Controls the amount of light reaching the specimen. |
| Arm | d | Part connecting the head and the base. |
| Depth of field | o | Measure of the thickness of the specimen in focus. |
| Fine focus | i | Knob that makes small adjustments in focus/stage position. |
| X-Y stage controls | l | Controls that move the slide vertically and horizontally on the stage. |
| Light source | a | Light source in the bottom of the microscope, also known as the illuminator. |
| Total magnification | m | Ocular magnification multiplied by objective magnification. |
| Head | b | Also known as the body; carries the oculars. |
| Base | c | Microscope support. |
| Objective lens | f | Major lenses closest to the specimen. |
| Coarse focus | h | Knob that makes large-scale focus adjustments. |
| Field of view | n | Visible area seen through the oculars. |

## Lab Activity 2.1 — Magnification table

| Lens | Ocular Lens | Objective Lens | Total Magnification |
|---|---:|---:|---:|
...
These are standard classroom estimates. If your instructor gave actual microscope measurements, use those numbers instead.

| Question | Completed Answer |
|---|---|
| Scanning lens field diameter | 4 mm |
| Scanning lens field diameter in micrometers | 4000 µm |
| Low-power lens field diameter | 1.6 mm |
| Low-power lens field diameter in micrometers | 1600 µm |
| High-power lens field diameter | 0.4 mm |
| High-power lens field diameter in micrometers | 400 µm |
| Oil-immersion lens field diameter | 0.16 mm |
| Oil-immersion lens field diameter in micrometers | 160 µm |

## Focusing Exercises — Letter “e”

| Prompt | Completed Answer |
|---|---|
| Describe the difference between the letter “e” on the slide and the letter “e” seen through the microscope. | The microscope image is inverted and reversed, so the letter appears upside down and backward. |

## Depth of Field — Three Colored Threads

| Prompt | Completed Answer |
|---|---|
| Do you have to move the adjustment knob more or less with the low-power lens than with the scanning lens? | Less. Higher magnification needs smaller, more careful focus adjustments. |
| Is the entire thickness of the thread in focus under high power as it was under scanning power? | No. |
| What does this show about depth of field when using high power? | Depth of field decreases as magnification increases, so less of the specimen is in focus at one time. |
