...
# Completed Answers for Chapter 5

## Prelab Activity 5.1 — Key Terms

| Term | Completed Definition |
|---|---|
| Epidermis | Outermost layer of skin made of keratinized stratified squamous epithelium. |
| Dermis | Connective tissue layer under the epidermis containing blood vessels, nerves, glands, and hair follicles. |
| Hypodermis | Subcutaneous layer under the dermis, mostly areolar and adipose tissue. |
| Keratinocyte | Main epidermal cell that produces keratin. |
| Melanocyte | Cell that produces melanin pigment. |
| Langerhans cell | Immune cell in the epidermis. |
| Tactile/Merkel cell | Sensory cell associated with touch. |
| Sebaceous gland | Oil gland that secretes sebum. |
| Sudoriferous gland | Sweat gland. |
| Arrector pili muscle | Smooth muscle that raises the hair and causes goose bumps. |

## Prelab Activity 5.2 — Labeling Layers and Structures
...
| Dermis | Middle connective tissue layer. |
| Hypodermis | Deep subcutaneous layer. |

### Accessory Structures

| Structure | Completed Answer |
|---|---|
| Hair shaft | Hair above the skin surface. |
| Hair root | Hair below the skin surface. |
| Hair follicle | Tube-like sheath that surrounds the hair root. |
| Sebaceous gland | Oil gland attached to hair follicle. |
| Sweat gland | Produces sweat. |
| Arrector pili muscle | Pulls hair upright. |

## Table 5.1 — Epidermal Layers Superficial to Deep

| Layer | Completed Description |
|---|---|
...
| Stratum spinosum | Contains keratinocytes and Langerhans cells; gives strength. |
| Stratum basale | Deepest epidermal layer; contains stem cells and melanocytes. |

## Lab Activity 5.1 — Thick Skin vs. Thin Skin

| Question | Completed Answer |
|---|---|
| What differences do you note in appearance and structure? | Thick skin has a thicker epidermis, a visible stratum lucidum, deeper ridges, more sweat glands, and no hair follicles. Thin skin has a thinner epidermis and usually contains hair follicles, sebaceous glands, and arrector pili muscles. |
| Where is each type located? | Thick skin is found on palms, soles, and fingertips. Thin skin covers most other body surfaces. |
| Function explanation | Thick skin protects areas exposed to friction. Thin skin provides protection while allowing flexibility, sensation, hair growth, and gland activity. |

## Lab Activity 5.3 — Dermis

| Dermal Layer | Completed Answer |
|---|---|
| Papillary layer | Superficial dermis; areolar connective tissue; contains dermal papillae and capillaries. |
| Reticular layer | Deeper dermis; dense irregular connective tissue; contains hair follicles, glands, nerves, and blood vessels. |

## Table 5.3 — Dermal Structures and Functions

| Structure | Completed Function |
|---|---|
| Hair follicle | Produces and surrounds the hair root. |
| Hair shaft | Visible portion of hair above the skin surface. |
| Hair root | Portion of hair below the surface. |
| Hair bulb | Growth area at the base of the hair. |
| Sebaceous gland | Produces oily sebum to lubricate skin and hair. |
| Merocrine/eccrine sweat gland | Produces watery sweat for cooling. |
| Apocrine sweat gland | Produces thicker sweat in areas such as axilla and groin. |
...
| Free nerve ending | Detects pain, temperature, and itch. |

## Post Lab Activity 5.1 — Concept Questions

| Question | Completed Answer |
|---|---|
| What are the three protective functions of the integumentary system? | Protects against mechanical injury, protects against pathogens/chemicals, and prevents water loss/UV damage. |
| What is the skin composed of? | Epidermis, dermis, and hypodermis. |
| What type of tissue makes up the epidermis? | Keratinized stratified squamous epithelium. |
| What pigment gives skin color? | Melanin. |
| What gland produces oil? | Sebaceous gland. |
| What gland produces sweat? | Sudoriferous gland. |

## Post Lab Activity 5.2 — Matching Table 5.4
...
## Table 5.5 — Identification of Dermal Structures

Because figure numbering can vary by diagram version, verify placement on your exact Figure 5.15. Standard answers are:

| Dermal Structure | Completed Identification |
|---|---|
| Pore | Opening at the skin surface. |
| Arrector pili muscle | Small muscle attached to hair follicle. |
| Meissner's corpuscle | Touch receptor in dermal papillae. |
| Pacinian corpuscle | Onion-shaped pressure receptor deep in dermis/hypodermis. |
| Keratinocyte | Main cell of epidermis. |
| Apocrine sweat gland | Coiled gland associated with hair follicle. |
| Hair follicle | Sheath around hair root. |
| Dermal papillae | Upward projections of dermis into epidermis. |
| Merocrine sweat gland | Coiled sweat gland opening to skin surface. |
| Hair root | Hair below surface. |
| Sebaceous gland | Oil gland beside hair follicle. |
| Free nerve ending | Branching sensory nerve ending. |
| Hair shaft | Hair above surface. |

## Table 5.6 — Match the Statement
...
## Post Lab Activity 5.3 — Crossword
...
| Question | Completed Answer |
|---|---|
| Layers cut through from superficial to deep to reach a bullet in the abdomen near the spine | Stratum corneum, stratum granulosum, stratum spinosum, stratum basale, dermis, hypodermis/subcutaneous tissue, then deeper fascia/muscle as needed. Stratum lucidum is not usually present in abdominal thin skin. |
...
| How does skin regulate body temperature when temperature rises? | Sweat glands release sweat, which cools the body as it evaporates. Blood vessels in the dermis dilate, bringing more warm blood to the surface so heat can be released. |
| Why is a light-skinned person more susceptible to malignant melanoma? | Lighter skin has less melanin protection from ultraviolet radiation, so UV damage to skin cell DNA is more likely. |

## Post Lab Activity 5.5 — Labeling

### Layers of the Epidermis

| Layer Order | Completed Answer |
|---:|---|
| 1 | Stratum corneum |
...
| Hair root | Portion of hair below skin surface. |
| Hair bulb | Deep growth region of hair. |
| Hair follicle | Sheath surrounding hair root. |
| Arrector pili muscle | Smooth muscle that raises hair. |
| Sebaceous gland | Oil-producing gland. |
| Apocrine sweat gland | Sweat gland opening into a hair follicle. |

## Post Lab Activity 5.6 — Fill in the Blanks

| Prompt | Completed Answer |
|---|---|
| Name the layers of the dermis. | Papillary layer and reticular layer. |
| Three major gland types and functions | Sebaceous glands produce oil; merocrine/eccrine sweat glands cool the body; apocrine sweat glands secrete thicker sweat into hair follicles. |
| Three protective functions | Protects from injury, prevents water loss, protects against pathogens/UV radiation. |
| Four functions of the integumentary system | Protection, temperature regulation, sensation, vitamin D synthesis. |
| Type of epithelial tissue in skin | Keratinized stratified squamous epithelium. |
| Five layers of thick skin | Stratum corneum, stratum lucidum, stratum granulosum, stratum spinosum, stratum basale. |
| Layer not present in thin skin | Stratum lucidum. |
| Four accessory structures in dermis | Hair follicles, sebaceous glands, sweat glands, arrector pili muscles. |
