...
# Completed Answers for Chapter 4

## Prelab Activity 4.1 — Tissue Types

| Tissue Type | Completed Description / Function |
|---|---|
| Epithelial tissue | Covers body surfaces, lines cavities, forms glands, protects, absorbs, secretes, and filters. |
| Connective tissue | Supports, binds, protects, stores energy, and transports substances. |
| Muscle tissue | Contracts to produce movement. |
| Nervous tissue | Sends electrical signals for communication and control. |

## Epithelial Tissue Classification

| Tissue | Number of Layers | Cell Shape | Main Function |
|---|---|---|---|
| Simple squamous epithelium | One layer | Flat cells | Diffusion and filtration |
| Simple cuboidal epithelium | One layer | Cube-shaped cells | Secretion and absorption |
| Simple columnar epithelium | One layer | Tall cells | Absorption and secretion |
| Pseudostratified columnar epithelium | Appears layered but is one layer | Tall cells, often ciliated | Secretion and movement of mucus |
| Stratified squamous epithelium | Many layers | Surface cells flat | Protection |
| Transitional epithelium | Many layers that stretch | Rounded/variable cells | Allows stretching in urinary organs |

## Lab Activity 4.1 — Figure Identification Guide

Use your figure numbers to verify exact placement. The common epithelial examples are:

| Figure | Completed Tissue Identification | Key Features |
|---|---|---|
| Figure 4.3 | Simple squamous epithelium | Thin, flat cells; good for diffusion. |
| Figure 4.4 | Simple cuboidal epithelium | Cube-shaped cells; round central nuclei. |
| Figure 4.5 | Simple columnar epithelium | Tall cells; nuclei near the base. |
| Figure 4.6 | Pseudostratified ciliated columnar epithelium | Appears layered; cilia may be visible. |
| Figure 4.7 | Stratified squamous epithelium | Many layers; protective surface. |
| Figure 4.8 | Transitional epithelium | Rounded cells that stretch. |

## Connective Tissue Types

| Tissue | Completed Characteristics | Function |
|---|---|---|
| Areolar connective tissue | Loose arrangement of fibers with many cell types. | Wraps and cushions organs; holds tissue fluid. |
| Adipose tissue | Large fat cells with nuclei pushed to the side. | Stores energy, insulates, cushions. |
| Dense regular connective tissue | Parallel collagen fibers. | Strong attachment; tendons and ligaments. |
| Dense irregular connective tissue | Collagen fibers in many directions. | Strength in multiple directions. |
| Hyaline cartilage | Glassy matrix with chondrocytes in lacunae. | Support and cushioning. |
| Elastic cartilage | Chondrocytes with elastic fibers. | Flexible support. |
| Fibrocartilage | Thick collagen bundles with chondrocytes. | Shock absorption. |
| Bone | Hard matrix with osteons/lacunae. | Support, protection, mineral storage. |
| Blood | Cells in liquid plasma. | Transport. |
...
| What tissue covers body surfaces and lines cavities? | Epithelial tissue. |
| What tissue binds, supports, and protects body structures? | Connective tissue. |
| What tissue contracts to create movement? | Muscle tissue. |
| What tissue sends electrical signals? | Nervous tissue. |

## Post Lab Activity 4.2 — Tissue Identification

| Figure | Completed Answer |
|---|---|
| Figure 4.10 | Simple squamous epithelium |
| Figure 4.11 | Simple cuboidal epithelium |
| Figure 4.12 | Simple columnar epithelium |
| Figure 4.13 | Pseudostratified ciliated columnar epithelium |
| Figure 4.14 | Stratified squamous epithelium |
| Figure 4.15 | Transitional epithelium |

## Post Lab Activity 4.3 — Crossword
...
## Review Keys — Connective Tissue Figures

| Figure | Completed Answer |
|---|---|
| Figure 4.23 | Bone |
| Figure 4.24 | Fibrocartilage |
| Figure 4.25 | Elastic cartilage |
| Figure 4.26 | Loose areolar tissue |
| Figure 4.27 | Dense regular connective tissue / tendon |
| Figure 4.28 | Adipose tissue |
